...
export default class VirtualizedMasonry extends React.PureComponent<IProps, {}> {
  public _columnCount = 0;
  ...
  render() {
    ...
    return <div style={{ height, width: '100%' }}>{this._renderAutoSizer({ height })}</div>;
  }
}
