...
function MyDropzone() {
  ...
  return (
    <div className="show-svg-container">
      {
        !svgFiles.length
          ? <div title={`${isDragActive ? 'Drop the files here ...' : 'Drag some files here, or click to select files'}`} className="multi-svg-container">
          ...
          : <Fragment>
            ...
            <div style={{ width: "100%" }} title={`${isDragActive ? 'Drop the files here ...' : 'Drag some files here, or click to select files'}`} className="multi-svg-container">
                    ...
                    <input {...getInputProps()} />
                    {
                      isDragActive ?
                        ...
                        <div className="upload-button-content-border">
                          ...
                          <div className="plus-text">Drag some files here, or click to select files</div>
                        </div>
                    }
                  </div>
                </div>
